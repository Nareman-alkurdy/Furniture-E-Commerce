...
async function loadProducts() {
    try {
        ...
        // Load categories from products if API fails
...
// Load categories from products as backup
function loadCategoriesFromProducts() {
    ...
    if (select && categories.length > 0) {
        ...
        console.log('Categories loaded from products:', categories);
    }
}
...
async function loadCategories() {
    try {
        ...
        console.log('Categories added to select');
    } catch (error) {
